 ...
 *   2. ENROLLMENT OVERRIDE — an enrolled student can browse a PAST enrollment
 *      via the enrollment switcher; the chosen id is threaded as `?enrollment_id=`
 *      onto every enrolled query and folded into the query cache key. `null`
 *      means "the server's current active enrollment" (the default).
 *
